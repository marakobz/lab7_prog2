...
public class DatabaseUserManager {
    ...
    public User getUserById(int userId) throws SQLException {
        ...
        try {
            ...
            Console.println("Выполнен запрос SELECT_USER_BY_ID.");
            if (resultSet.next()) {
                user = new User(
    ...
    public boolean checkUserByUsernameAndPassword(User user) throws DatabaseHandlingException {
        ...
        try {
            ...
            Console.println("Request is completed: SELECT_USER_BY_USERNAME_AND_PASSWORD.");
    ...
    public int getUserIdByUsername(User user) throws DatabaseHandlingException {
        ...
        try {
            ...
            Console.println("Request is completed: SELECT_USER_BY_USERNAME.");
            if (resultSet.next()) {
            ...
            Console.printerror("Mistake occurred while trying to process SELECT_USER_BY_USERNAME!");
            throw new DatabaseHandlingException();
        } finally {
    ...
    public boolean insertUser(User user) throws DatabaseHandlingException {
        ...
        try {
            ...
            Console.println("Request is completed: INSERT_USER.");
            return true;
        } catch (SQLException exception) {
            Console.println("Mistake occurred while trying to process INSERT_USER!");
            throw new DatabaseHandlingException();
        } finally {
